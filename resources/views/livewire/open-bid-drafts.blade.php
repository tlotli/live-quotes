            ...
            @foreach($quotes as $q)
                <div class="card card-post-aside card-post-1 blog-card">
                    <div class="card-body">
                        ...
                        <div class="meta-box">
                            <ul class="p-0 mt-2 list-inline">
                                <li class="list-inline-item">Submitted By : <span
                                        class="badge badge-boxed  badge-soft-success"> {{$q->company_name}}</span>
                                </li>
                                <li class="list-inline-item">Industry : <span
                                        class="badge badge-boxed  badge-soft-primary">{{$q->name}}</span>
                                </li>
                        ...
                        <a href="{{route('submit_bid' , ['id' => $q->id])}}" class="btn btn-info btn-sm">Complete Bid   <i class="fas fa-long-arrow-alt-right"></i></a>
                    </div>
                </div>
            @endforeach
            {{$quotes->links()}}
