                    ...
                    <div class="col-xl-12 col-12">
                        <div class="widget has-shadow">
                            ...
                            <div class="widget-header bordered no-actions d-flex align-items-center">
                                <h4 class="text-muted">Complete Company Information</h4>
                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mt-4">
                                                ...
                                                <textarea name="company_profile" id="company_profile" cols="30" rows="10" class="form-control" wire:model="company_profile">{{old('company_profile')}}</textarea>
{{--                                                <input id="company_profile" type="hidden" name="content">--}}
{{--                                                <trix-editor--}}
{{--                                                    class="formatted-content"--}}
{{--                                                    x-ref="trix"--}}
{{--                                                    wire:model.debounce.999999ms="company_profile"--}}
{{--                                                    wire:key="uniqueKey"--}}
{{--                                                ></trix-editor>--}}
                                                {{--                                                <textarea id="elm1"--}}
                                                {{--                                                          wire:key="uniqueKey"--}}
                                        ...
                                        <div class="text-left mt-3">
                                            <button type="submit" class="btn btn-success btn-lg mr-1 mb-2"><i
                                                    class="la la-check"></i>Create Business Profile
                                            </button>
                                        </div>
