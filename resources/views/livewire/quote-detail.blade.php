                        ...
                        <div class="col-md-3">
                            <div class="float-left">
                                <address class="font-13">
                                    ...
                                    {{\Illuminate\Support\Facades\Auth::user()->business_profile->company_name}}<br>
                                    {{\Illuminate\Support\Facades\Auth::user()->business_profile->company_address}}<br>
                                    {{\Illuminate\Support\Facades\Auth::user()->business_profile->company_province}}
                                    , {{\Illuminate\Support\Facades\Auth::user()->business_profile->company_city}}<br>
                                    <abbr
                                        title="Phone">P:</abbr> {{\Illuminate\Support\Facades\Auth::user()->business_profile->company_telephone}}
                                </address>
                            </div>
                        </div>
                    </div>
